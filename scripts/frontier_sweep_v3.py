...
def main() -> int:
    ...
    logger.info(
        "frontier_v3_config strategy=%s param_sets=%d windows=%s scenarios=%s sampled=%s",
        args.strategy,
        len(param_sets),
        ...
        ranked.append(
            {
                ...
                "test_macro_full_time_share_stress_1": float((test.get("stress_1") or test.get("baseline") or {}).get("macro_full_time_share", 0.0) or 0.0),
            }
        )
